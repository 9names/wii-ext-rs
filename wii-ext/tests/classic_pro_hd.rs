...
#[rustfmt::skip]
assert_joystick_hd!(
    PRO_HD_IDLE, PRO_HD_LJOY_L, // Set idle and test sample
...
#[rustfmt::skip]
assert_joystick_hd!(
    PRO_HD_IDLE, PRO_HD_LJOY_R, // Set idle and test sample
...
#[rustfmt::skip]
assert_joystick_hd!(
    PRO_HD_IDLE, PRO_HD_LJOY_D, // Set idle and test sample
...
#[rustfmt::skip]
assert_joystick_hd!(
    PRO_HD_IDLE, PRO_HD_LJOY_U, // Set idle and test sample
    -ZERO_SLOP, ZERO_SLOP, // acceptable range for left x axis
...
#[rustfmt::skip]
assert_joystick_hd!(
    PRO_HD_IDLE, PRO_HD_RJOY_L, // Set idle and test sample
    -ZERO_SLOP, ZERO_SLOP, // acceptable range for left x axis
    -ZERO_SLOP, ZERO_SLOP, // acceptable range for left y axis
...
#[rustfmt::skip]
assert_joystick_hd!(
    PRO_HD_IDLE, PRO_HD_RJOY_R, // Set idle and test sample
    -ZERO_SLOP, ZERO_SLOP, // acceptable range for left x axis
    -ZERO_SLOP, ZERO_SLOP, // acceptable range for left y axis
...
#[rustfmt::skip]
assert_joystick_hd!(
    PRO_HD_IDLE, PRO_HD_RJOY_D, // Set idle and test sample
    -ZERO_SLOP, ZERO_SLOP, // acceptable range for left x axis
    -ZERO_SLOP, ZERO_SLOP, // acceptable range for left y axis
    -ZERO_SLOP, ZERO_SLOP, // acceptable range for right x axis
...
#[rustfmt::skip]
assert_joystick_hd!(
    PRO_HD_IDLE, PRO_HD_RJOY_U, // Set idle and test sample
    -ZERO_SLOP, ZERO_SLOP, // acceptable range for left x axis
    -ZERO_SLOP, ZERO_SLOP, // acceptable range for left y axis
    -ZERO_SLOP, ZERO_SLOP, // acceptable range for right x axis
